...
//Reads your config file
    //I don't think this needs to be modified for new functionality
    //but it REALLY needs to get more brackets so it can be readable
...
void makeip(char *ip_tmpl, char *in, char *out){
  static char ip[0x8000];   //Size of IP.BIN, 32768 Bytes
  ...
  //Fill our file buffer with the template
...
int main(int argc, char *argv[]){
  ...
  //Searches environment for template file
    //otherwise chooses local template file
